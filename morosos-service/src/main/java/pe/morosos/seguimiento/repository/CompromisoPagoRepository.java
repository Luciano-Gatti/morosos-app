...
public interface CompromisoPagoRepository extends JpaRepository<CompromisoPago, UUID> {
    ...
    Optional<CompromisoPago> findTopByCasoSeguimientoIdAndEstadoOrderByFechaDesdeDesc(UUID casoSeguimientoId, pe.morosos.seguimiento.entity.CompromisoPagoEstado estado);
}
