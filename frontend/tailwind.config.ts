  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        status: {
          ...
          paused: {
            ...
            soft: "hsl(var(--status-paused-soft))",
          },
          closed: {
          ...
          debt: {
            DEFAULT: "hsl(var(--status-debt))",
            foreground: "hsl(var(--status-debt-foreground))",
            soft: "hsl(var(--status-debt-soft))",
          },
        },
        sidebar: {
      ...
      boxShadow: {
        ...
        "institutional-lg": "var(--shadow-lg)",
      },
      borderRadius: {
        lg: "var(--radius)",
